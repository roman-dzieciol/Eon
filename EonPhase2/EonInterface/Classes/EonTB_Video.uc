...
//		Log("ILoadINI" @ GUIMenuOption(Sender).Caption @ s, 'GUI');
	...
	switch( Sender )
	{
		...
		case DetailBlur:				DetailBlur.SetValue( class'ECFG_MotionBlur'.default.MotionBlur );			break;
		...
		case DetailShadow: 				DetailShadow.SetIndexText( class'ECFG_Shadow'.default.ShadowType );			break;
		case DetailRagdoll: 			DetailRagdoll.SetIndexText( class'ECFG_Karma'.default.RagdollDetail );		break;
...
function IChange(GUIComponent Sender)
{
	...
	switch( Sender )
	{
		...
		case DetailBlur:
			...
			class'ECFG_MotionBlur'.default.MotionBlur = DetailBlur.GetValue();
			class'ECFG_MotionBlur'.static.StaticSaveConfig();
		break;
		...
		case DetailShadow:
			class'ECFG_Shadow'.default.ShadowType = DetailShadow.GetIndex();
		...
		case DetailRagdoll:
			class'ECFG_Karma'.default.RagdollDetail = DetailRagdoll.GetIndex();
