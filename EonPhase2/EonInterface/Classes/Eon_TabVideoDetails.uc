...
#include ../_inc/const/ShadowType.uc
...
function InternalOnLoadINI(GUIComponent Sender, string s)
{
	...
	switch( Sender )
	{
		...
		case DetailShadow:
			switch( class'ECFG_Shadow'.default.ShadowType )
			{
		...
		case DetailRagdoll:
			switch( class'ECFG_Karma'.default.RagdollDetail )
			{
...
function InternalOnChange(GUIComponent Sender)
{
	...
	switch( Sender )
	{
		...
		case DetailShadow:
			...
			{
				case 0:	class'ECFG_Shadow'.default.ShadowType = ST_None;		break;
				case 1:	class'ECFG_Shadow'.default.ShadowType = ST_Blob;		break;
				case 2:	class'ECFG_Shadow'.default.ShadowType = ST_Static;		break;
				case 3:	class'ECFG_Shadow'.default.ShadowType = ST_SunBased;	break;
			}
			class'ECFG_Shadow'.static.StaticSaveConfig();
		break;
		...
		case DetailRagdoll:
			...
			{
				case 0:	class'ECFG_Karma'.default.RagdollDetail = RDL_High;		break;
				case 1:	class'ECFG_Karma'.default.RagdollDetail = RDL_Medium;	break;
				case 2:	class'ECFG_Karma'.default.RagdollDetail = RDL_Low;		break;
			}
			class'ECFG_Karma'.static.StaticSaveConfig();
		break;
	}
}
